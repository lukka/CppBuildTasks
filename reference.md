...
```yaml
   - task: lucappa.cmake-ninja-vcpkg-tasks.d855c326-b1c0-4d6f-b1c7-440ade6835fb.run-vcpkg@0
     ...
     inputs:
       ...
       # [required] arguments to vcpkg install command, e.g. a response file containing the list of packages as well as the triplet to be used for all packages
       ...
       # [optional] the commit id or tag of the vcpkg repo to fetch. Branch names are no recommended here if you are using the same value as part of the key in CacheBeta task.
